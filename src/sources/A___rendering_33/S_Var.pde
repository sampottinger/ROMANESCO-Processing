...
boolean camera_global_is =false;
boolean camera_item_is =false;
...
//long touch
boolean key_v_long; // use to boolean camera_item_is 
boolean key_l_long, key_n_long;
...
vec3 [] eye_cameraSetting, scene_cameraSetting;
...
void create_var_P3D(int num_setting_camera) {
   // setting and save
   eye_cameraSetting = new vec3 [num_setting_camera];
   scene_cameraSetting = new vec3 [num_setting_camera];
